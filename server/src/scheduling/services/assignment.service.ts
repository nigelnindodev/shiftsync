...
export class AssignmentService {
  ...
  async assignStaff(
    ...
    // 2-step validation: run constraints immediately before assigning
    ...
    // Create assignment with advisory lock
    // Signature: createWithLock(shiftSkillId, staffMemberId, managerId, recurringAssignmentId)
  ...
  async removeAssignment(
    ...
    // Update assignment state to CANCELLED
